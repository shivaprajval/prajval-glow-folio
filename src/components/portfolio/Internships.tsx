...
const awsCert = { url: "/certs/aws_data_engineering_internship.pdf" };
const googleCert = { url: "/certs/google_ai_ml_internship.pdf" };
const fsJavaCert = { url: "/certs/full_stack_java_internship.pdf" };
